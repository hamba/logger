...
func TestJsonFormat(t *testing.T) {
	...
	b := f.Format("some message", logger.Error, []interface{}{"x", 1, "y", 3.2, "bool", true,
...
func TestJsonFormat_KeyError(t *testing.T) {
	...
	b := f.Format("some message", logger.Error, []interface{}{1, "y"})
...
func TestJsonFormat_Ints(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"int", 1, "int8", int8(2), "int16", int16(3), "int32", int32(4), "int64", int64(5)})
...
func TestJsonFormat_Uints(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"uint", uint(1), "uint8", uint8(2), "uint16", uint16(3), "uint32", uint32(4), "uint64", uint64(5)})
...
func TestJsonFormat_Floats(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"float32", float32(1), "float64", float64(4.56)})
...
func TestJsonFormat_Time(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"time", time.Unix(1541573670, 0).UTC()})
...
func TestJsonFormat_Unknown(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"what", obj, "nil", nil})
...
func TestLogfmtFormat(t *testing.T) {
	...
	b := f.Format("some message", logger.Error, []interface{}{"x", 1, "y", 3.2, "bool", true, "equals", "=", "quote", "\"",
		"carriage_return", "bang" + string('\r') + "foo", "tab", "bar	baz", "newline", "foo\nbar", "escape", string('\\')})
...
func TestLogfmtFormat_Floats(t *testing.T) {
	...
	b := f.Format("", logger.Error, []interface{}{"float32", float32(1.23), "float64", float64(4.56)})
